...
#include <string.h>  /* size_t, mutils.h */
...
#error "This program requires C++11 or higher."
	...
	#include <limits.h>
		...
		#define _mutils_gcc_clz_sizet(n) (size_t)__builtin_clzll((unsigned long long)(n))

	// Use #elif instead of #if because ULLONG_MAX might equal ULONG_MAX.
	#elif (SIZE_MAX == ULONG_MAX)
		#define _mutils_gcc_clz_sizet(n) (size_t)__builtin_clzl((unsigned long)(n))

	#elif (SIZE_MAX == UINT_MAX)
		#define _mutils_gcc_clz_sizet(n) (size_t)__builtin_clz((unsigned int)(n))
	#endif
#endif
